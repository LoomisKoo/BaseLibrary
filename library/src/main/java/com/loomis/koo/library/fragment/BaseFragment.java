package com.loomis.koo.library.fragment;
...
import com.loomis.koo.library.adapter.HeaderFooterViewModel;
import com.loomis.koo.library.manager.FragmentUserVisibleManager;
...
public abstract class BaseFragment<P> extends Fragment implements FragmentUserVisibleManager.UserVisibleCallback {
    ...
    @BindView(R2.id.base_pager_list_topLay)
    LinearLayout basePagerListTopLay;
    @BindView(R2.id.base_pager_list_ll)
    protected LinearLayout       basePagerListLl;
    @BindView(R2.id.base_pager_list_refreshLayout)
    protected SmartRefreshLayout basePagerListRefreshLayout;
    @BindView(R2.id.base_pager_list_empty_tv)
    TextView     basePagerListEmptyTv;
    @BindView(R2.id.base_pager_list_bottomLay)
    LinearLayout basePagerListBottomLay;
    @BindView(R2.id.base_pager_list_root)
